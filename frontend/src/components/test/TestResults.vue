...
<template>
  ...
  >
    <div class="mb-3 flex items-center justify-between">
      <h3 class="text-sm font-semibold text-gray-300">Results</h3>
    ...
    <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
      ...
      >
        ...
        <div
          ...
          :class="testStore.testResult.packet_loss > 0 ? 'text-red-400' : 'text-green-400'"
        >
      ...
      >
        ...
        <div class="mt-1 text-lg font-semibold text-primary-400">
      ...
      >
        ...
        <div class="mt-1 text-sm font-mono font-semibold text-white">
    ...
    >
      <div class="rounded bg-gray-800/50 px-3 py-2 text-center">
    ...
    <div
      ...
      class="mt-3 rounded-lg border border-red-800 bg-red-900/20 px-3 py-2 text-sm text-red-400"
    >
